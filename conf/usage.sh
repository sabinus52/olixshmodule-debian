...
function olixmodule_debian_usage_install()
{
    ...
    echo -e "${Cjaune} mysql      ${CVOID} : Installation et configuration de MySQL"
    echo -e "${Cjaune} mariadb    ${CVOID} : Installation et configuration de MariaDB"
...
function olixmodule_debian_usage_config()
{
    ...
    echo -e "${Cjaune} mysql      ${CVOID} : Configuration de MySQL"
    echo -e "${Cjaune} mariadb    ${CVOID} : Configuration de MariaDB"
...
function olixmodule_debian_usage_savecfg()
{
    ...
    echo -e "${Cjaune} mariadb    ${CVOID} : Sauvegarde de la configuration de MariaDB"
